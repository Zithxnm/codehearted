...
<head>
    ...
    <link rel="stylesheet" href="../css/CompFund_Styles.css?v=<?php echo $cssVersion; ?>">
</head>
...
<body>
        ...
        <div class="lesson">
            ...
            <div class="content-grid">
                ...
                <div class="lesson-section">
                    ...
                    $moduleFolders = [
                        'module1_CCS_OHS_Policies_&_Tools',
                        'module2_Hardware_Assembly',
                        'module3_BIOS_UEFI_&_Bootable_Media',
                        'module4_Installing_OS_&_Drivers',
                        'module5_Installing_Applications_&_Licensing',
                    ];
                    ...
                    ?>
                        <div class="lesson-card" data-module-index="<?php echo $i; ?>">
                            ...
                            <a href="FundamentalsOfComputing/<?php echo $moduleFolders[$i]; ?>/review.php"
                                class="action-button review" data-action="review" data-module="<?php echo $i; ?>">Review</a>

                            <a href="FundamentalsOfComputing/<?php echo $moduleFolders[$i]; ?>/practice.php"
                                class="action-button" data-action="practice" data-module="<?php echo $i; ?>" style="margin-left:8px;">Practice</a>

                            <a href="FundamentalsOfComputing/<?php echo $moduleFolders[$i]; ?>/quiz.php"
    ...
    <script src="../js/CompFund_Scripts.js?v=<?php echo $jsVersion; ?>"></script>
</body>
