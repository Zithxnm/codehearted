...
<head>
    ...
    @vite('resources/css/modules/digilogic/mod1/review1.css')
</head>
    ...
    <main class="lesson-content">
        <div class="review-container">
            ...
            <div class="lesson-nav">
                <a href="{{ route('digilogic.mod1.practice') }}" class="action-button">Go to Practice</a>
                <a href="{{ route('digilogic.mod1.quiz') }}" class="action-button" style="margin-left:8px;">Take Quiz</a>
            </div>
        </div>
    </main>
</body>
