...
<head>
    ...
    @vite('resources/css/modules/compfund/mod5/review5.css')
</head>

<body>
    <main class="lesson-content">
        <div class="review-container">
            <h1>Lesson 5: Installing Applications & Licensing</h1>
            ...
            <section class="core-lesson">
                ...
                <ul>
                    ...
                    <li><strong>Reliabilityt</strong> — Licensed applications run more smoothly and with fewer issues.</li>
                </ul>
            ...
            <section class="references">
                ...
                <ul>
                    ...
                    <li> Black Duck. (2024, March 21). Five types of software licenses you need to understand. Black Duck. https://www.blackduck.com/blog/5-types-of-software-licenses-you-need-tounderstand.htmlblackduck.comli>
            </section>

            <!-- Navigation Buttons -->
            <div class="lesson-nav">
                <a href="{{ route('compfund.mod5.practice') }}" class="action-button">Go to Practice</a>
                <a href="{{ route('compfund.mod5.quiz') }}" class="action-button" style="margin-left:8px;">Take Quiz</a>
            </div>
        </div>
    </main>
</body>
