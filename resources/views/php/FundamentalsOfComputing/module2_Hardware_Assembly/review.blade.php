...
<head>
    ...
    @vite('resources/css/modules/compfund/mod2/review2.css')
</head>

<body>
    <main class="lesson-content">
        <div class="review-container">
            <h1>Lesson 2: Hardware Assembly</h1>
            ...
            <section class="core-lesson">
                ...
                <ul>
                    <li>Hard Disk Drive (HDD): Stores operating system, software, and files.</li>
                    <li>Solid State Drive (SSD): Faster, modern alternative to HDD with no moving parts.</li>
                    <li>Optical Drive (optional): Reads CDs/DVDs (less common today).</li>
                </ul>
            ...
            <section class="references">
                <h2>📚 References</h2>
                <ul>
                    <li>American Public University System. (n.d.). Basic components of a computer: How they function. APU Resources. https://www.apu.apus.edu/area-of-study/informationtechnology/resources/basic-components-of-a-computer/</li>
                    <li>Elahi, G. (2022). Computer systems: Digital design, fundamentals of computer architecture and ARM assembly language. Springer. https://doi.org/10.1007/978-3-030-93449-1</li>
                    <li>GCFGlobal. (n.d.). Computer basics: Inside a computer. GCFGlobal. https://edu.gcfglobal.org/en/computerbasics/inside-a-computer/1/</a></li>
                    <li>Lenovo. (n.d.). What is a system unit? Lenovo Glossary. https://www.lenovo.com/us/en/glossary/system-unit/</li>
                    <li>OpenBookProject. (n.d.). Internal computer hardware. OpenBookProject. https://openbookproject.net/courses/intro2ict/hardware/internal.html</li>
                    <li>Technical Education and Skills Development Authority (TESDA). (2019). Computer systems servicing NC II: Curriculum guide. Department of Education, Republic of the Philippines. https://www.deped.gov.ph/wp-content/uploads/2019/01/ComputerSystems-Servicing-NC-II-CG.pdf</li>
                    <li>University of California, Riverside. (n.d.). Computer hardware overview. Department of Computer Science and Engineering. https://www.cs.ucr.edu/~gusta/cs8w04/hardware.html</li>
                </ul>
            </section>
