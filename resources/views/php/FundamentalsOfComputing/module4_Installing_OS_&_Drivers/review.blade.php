...
<head>
    ...
    <link rel="stylesheet" href="../module4_Installing_OS_&_Drivers/review4.css?php echo time(); ?>">
</head>

<body>
    <main class="lesson-content">
        <div class="review-container">
            <h1>Lesson 4: Installing OS & Drivers</h1>
            ...
            <section class="references">
                <h2>📚 References</h2>
                <ul>
                    <li>Microsoft. (n.d.). Windows Setup installation process. Microsoft Learn. https://learn.microsoft.com/en-us/windowshardware/manufacture/desktop/windows-setup-installationprocess?view=windows-11 Microsoft Learn </li>
                    <li>Microsoft. (2024, September 20). Understanding Windows Update rules for driver distribution. Microsoft Learn. https://learn.microsoft.com/en-us/windowshardware/drivers/dashboard/understanding-windows-update-automatic-andoptional-rules-for-driver-distribution Microsoft Learn</li>
                    <li>GeeksforGeeks. (2021, November XX). Different methods of Operating System Installation. GeeksforGeeks. https://www.geeksforgeeks.org/operatingsystems/tips-and-tricks-on-operating-system-installations/ GeeksforGeeks</a></li>
                    <li>SANS Institute. (n.d.). Operating System Installation Guidelines. SANS.  https://www.sans.org/media/security-training/os_install2.pdf SANS Institute</li>
                </ul>
            </section>
