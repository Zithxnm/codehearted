...
<head>
    ...
    @vite('resources/css/modules/progfund/mod1/review1.css')
</head>

<body>
    <main class="lesson-content">
        <div class="review-container">
            <h1>Lesson 1: Introduction to Programming and Basic Terminology</h1>
            ...
            <section class="core-lesson">
                ...
                <p>Python is a programming language created by <strong>Guido van Rossum</strong> in 1991. It’s named after the British comedy group “Monty Python’s Flying Circus,” not the snake!</p>
            ...
            <div class="lesson-nav">
                <a href="{{ route('progfund.mod1.practice') }}" class="action-button">Go to Practice</a>
                <a href="{{ route('progfund.mod1.quiz') }}" class="action-button" style="margin-left:8px;">Take Quiz</a>
            </div>
        </div>
    </main>
